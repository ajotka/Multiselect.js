class MultiSelect {
    ...
    init() {
        ...
        function MultiSelect($select) {
            ...
            this.toggleSelected = function($option, e, placeholder) {
                ...
                if (numChecked) {
                    ...
                    if (numChecked < 3) {
                        var selectedText = [];
                        $allCheckedOptions.find('.multi-select_label').each(function() {
            ...
            this.attachClickEvents = function(that, placeholder) {
                ...
                this.$options.on('click', function(e) {
                    that.toggleSelected($(this), e, placeholder);
                });
            }
            this.attachKeyboardEvents = function(that, placeholder) {
            ...
            this.init = function() {
                ...
                this.attachClickEvents(this, placeholder);
                this.attachKeyboardEvents(this, placeholder);
            }
